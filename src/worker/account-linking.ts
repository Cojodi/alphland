  ...
  try {
    ...
    await kysely
      ...
      .values({
        ...
        accessTokenExpiresAt: providerData.accessTokenExpiresAt || null,
        refreshTokenExpiresAt: providerData.refreshTokenExpiresAt || null,
        scope: providerData.scope || null,
        tokenType: providerData.tokenType || null,
        password: null,
        createdAt: now,
        updatedAt: now,
      })
