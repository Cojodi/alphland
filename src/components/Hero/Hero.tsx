...
const BannerCard = ({
  ...
  return (
    <div
      className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-5 flex flex-col flex-1 hover:border-orange/50 transition-colors cursor-pointer"
      onClick={() => router.push(url)}
    >
      {/* External link */}
      <Link href={url}>
        <a
          className="absolute top-4 right-4 text-white/40 hover:text-orange transition-colors"
